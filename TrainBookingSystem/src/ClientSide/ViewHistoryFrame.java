...
public class ViewHistoryFrame extends JFrame {
    ...
    public ViewHistoryFrame(Client client) {
        this.client = client;
    ...
    private void initUI() {
        ...
        JLabel lblTagline = new JLabel("My Reservations History");
        ...
        historyArea.setBackground(new Color(30, 24, 26));
        historyArea.setForeground(new Color(230, 230, 235));
        historyArea.setBorder(BorderFactory.createEmptyBorder(8, 8, 8, 8));

        JScrollPane scrollPane = new JScrollPane(historyArea);
        scrollPane.setPreferredSize(new Dimension(600, 280));
        scrollPane.setBorder(BorderFactory.createLineBorder(new Color(120, 90, 70)));
