 ...
 * @author sarah
 */
public class Availability102 extends javax.swing.JFrame {
   private Client client;
private String source, dest, cls;

 public Availability102(Client client, String source, String dest, String cls) {
    this.client= client;
    this.source= source;
    this.dest= dest;
    this.cls= cls;
